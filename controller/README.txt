...
controllerArduino.ino is not needed if you are using Nano + Shield (instead of just shield), but I still have it there just in case we decided to reduce the number of microcontroller.
